...
export const contestants = [
    ...
    Contestant("Jess", "24", "Executive Assistant", "San Diego, CA", "Jill"),
    ...
    Contestant("Kelsey T.", "31", "Actor", "Los Angeles, CA", "Jill"),
    ...
    Contestant("Lea", "23", "Account Manager", "Waipahu, HI", "Darius"),
    Contestant("Lexi", "30", "Digital Strategist", "Atlanta, GA", "Jill"),
    Contestant("Madina", "31", "Mental Health Therapist", "Charlotte, NC"),
    Contestant("Maria", "29", "Executive Assistant", "Kleinburg, ON", "Darius"),
