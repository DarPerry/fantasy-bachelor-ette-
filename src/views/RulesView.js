...
const endOfSeasonScoringRules = [
    ScoringCell("Hometown Date", 2),
    ScoringCell("Overnight Date", 2),
    ScoringCell("Proposal", 5),
    ScoringCell("Receiving Final Rose", 5),
];
            ...
            <Grid sx={{ flexGrow: 1 }} container spacing={2}>
                <Grid item xs={12}>
                    <>
                        ...
                        <GridRow rowItems={scoringCells.slice(0, 3)} />
                        <GridRow rowItems={scoringCells.slice(3, 6)} />
                    </>
                </Grid>
            </Grid>
        </Box>
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <PointGrid
                        header="Each Episode"
                        scoringCells={eachEpisodeScoringRules}
                    />
                    <PointGrid
                        header="End of Season"
                        scoringCells={endOfSeasonScoringRules}
                    />
                </Typography>
            </Box>
            {/* <Box
